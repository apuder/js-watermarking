var powergraph;
(function (powergraph_1) {
    var powergraphnode = (function () {
        function powergraphnode(id) {
            this.id = id;
            this.is_node = true;
            this.is_edge = false;
            this.outbound_edges = [];
        ...
        return powergraphnode;
    })();
    var powergraphedge = (function () {
        function powergraphedge(id) {
            this.id = id;
            this.is_node = false;
            this.is_edge = true;
            this.origin = null;
        ...
        return powergraphedge;
    })();
    var powergraph = (function () {
        function powergraph(num, length) {
            if (num < 0)
        ...
        // false otherwise
        powergraph.fbbhelper = function (stack) {
        ...
        powergraph.findbackbone = function (root) {
        ...
        powergraph.calccoef = function (key, ind, numitems) {
        ...
        powergraph.findcoef = function (key, backbone) {
        ...
        powergraph.findnum = function (root) {
            if (typeof (root) !== 'object')
                return null;
            var backbone = powergraph.findbackbone(root);
            if (!backbone)
                return null;
            var num = 0;
        ...
        powergraph.num_base = function (num) {
            var base = 2;
        ...
        powergraph.prototype.makenodes = function () {
            this.nodes = [];
        ...
        powergraph.prototype.makeedges = function () {
            this.edges = [];
            var tmpnum = this.num;
            var base = this.base;
        ...
        powergraph.prototype.get_component = function (id) {
    ...
    powergraph_1.powergraph = powergraph;
})(powergraph = exports.powergraph || (exports.powergraph = {}));
